...
@section('content')
	...
	@endif
	    ...
	    <h1 class="page-title"> Admin Dashboard
	        <small>statistics, charts, bookings and reports</small>
	    </h1>
	    <div class="page-bar">
	                ...
	                <div class="details">
	                    <div class="number">
	                        <span data-counter="counterup" data-value="1349">
	                        	@php
									echo \App\Schedule::where('date',date('Y-m-d'))->count();
	                        	@endphp
	                        </span>
	                    </div>
	                    <div class="desc"> Booked Today </div>
	                </div>
	            </a>
	        </div>
	        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
	                ...
	                <div class="details">
	                    <div class="number">
	                        <span data-counter="counterup" data-value="12,5">&#8369; {{ \App\Products::totalCost() }}</span> </div>
	                    <div class="desc"> Total Inventory </div>
	                </div>
	            </a>
	        </div>
	        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	            <a class="dashboard-stat dashboard-stat-v2 green" href="#">
	                ...
	                <div class="details">
	                    <div class="number">
	                        <span data-counter="counterup" data-value="549">24</span>
	                    </div>
	                    <div class="desc"> Below Minimum Stocking </div>
	                </div>
	            </a>
	        </div>
	        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
	            <a class="dashboard-stat dashboard-stat-v2 purple" href="#">
	                ...
	                <div class="details">
	                    <div class="number"> +
	                        <span data-counter="counterup" data-value="89"></span>1 </div>
	                    <div class="desc"> Absent Today </div>
	                </div>
	            </a>
	        </div>
	    </div>
